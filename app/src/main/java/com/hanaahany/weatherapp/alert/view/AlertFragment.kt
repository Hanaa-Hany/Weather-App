...
import com.hanaahany.weatherapp.alert.viewmodel.AlertViewModel
...
class AlertFragment : Fragment() {
    ...
    private fun showTimeDialog() {
        ...
        bindingAlertLayout.tvFromDateDialog.text =
            Constants.formatLongToAnyString(currentTimeInMillis, "dd MMM yyyy")
        bindingAlertLayout.tvFromTimeDialog.text =
            Constants.formatLongToAnyString(currentTimeInMillis + 60 * 1000, "hh:mm a")
        ...
        bindingAlertLayout.btnSaveDialog.setOnClickListener {
            ...
            val time = Constants.formatFromStringToLong(
                bindingAlertLayout.tvFromDateDialog.text.toString(),
                bindingAlertLayout.tvFromTimeDialog.text.toString()
            )


            val alarmItem = Alarm(time, kind, currentLatitude, currentLongitude, currentZoneName)
    ...
    private fun showSettingDialog() {
        MaterialAlertDialogBuilder(
            ...
            .setPositiveButton("Ok") { _, _ ->
                ...
                intent.data = Uri.parse("package:com.hanaahany.weatherapp")
    ...
    private fun showDatePicker() {
        ...
        datePicker.addOnPositiveButtonClickListener { date ->
            bindingAlertLayout.tvFromDateDialog.text =
                Constants.formatLongToAnyString(date, "dd MMM yyyy")
            showTimePicker()
        }
    }
    ...
    private fun showTimePicker() {
        ...
        timePicker.addOnPositiveButtonClickListener {
            ...
            bindingAlertLayout.tvFromTimeDialog.text =
                Constants.formatHourMinuteToString(timePicker.hour, timePicker.minute)
